...
const Feature = () => {
  return (
     <div className="font-[sans-serif] text-white bg-gradient-to-r from-[#6AD4DD] to-indigo-800 py-5 px-4 ">
     <div className="max-w-7xl mx-auto">
       <h2 className="sm:text-4xl text-2xl font-extrabold text-center mb-10 mt-5">Discover Our Exclusive Features</h2>
